          ...
          >
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-2xl rounded-3xl border border-gray-100">
              <div className="flex flex-col items-center">
                <div className="mx-auto flex-shrink-0 flex items-center justify-center h-16 w-16 rounded-full bg-red-100 sm:mx-0 sm:h-20 sm:w-20 mb-4 shadow-inner">
                ...
                <div className="mt-2">
                  <p className="text-base text-gray-500 text-center px-4">
                    Estás a punto de salir de tu cuenta. ¿Estás seguro de que quieres cerrar sesión?
                  </p>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row-reverse gap-3 w-full">
                  <button
                    type="button"
                    className="w-full inline-flex justify-center rounded-2xl border border-transparent shadow-lg px-6 py-3.5 bg-red-600 text-base font-bold text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all hover:scale-105 active:scale-95"
                    onClick={onConfirm}
                  >
                    Sí, cerrar sesión
                  </button>
