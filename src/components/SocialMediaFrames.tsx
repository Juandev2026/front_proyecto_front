    ...
    <div className="bg-white py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Facebook Frame */}
          <div className="rounded-xl overflow-hidden shadow-sm border border-gray-200 bg-white flex flex-col h-[500px]">
             <div className="bg-[#1877f2] p-2 px-3 flex justify-between items-center text-white h-10 shrink-0">
               <span className="font-bold text-sm">Facebook</span>
               <svg className="w-5 h-5 bg-white text-[#1877f2] rounded-full" viewBox="0 0 24 24" fill="currentColor">
                   <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.791-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
               </svg>
             </div>
             <div className="flex-grow flex justify-center items-start overflow-hidden bg-gray-50 pt-2">
                <div 
                    className="fb-page" 
                    data-href="https://www.facebook.com/JuancaDocenteOficial" 
                    data-tabs="timeline" 
                    data-width="340" 
                    data-height="500" 
                ...
                >
                    <blockquote cite="https://www.facebook.com/JuancaDocenteOficial" className="fb-xfbml-parse-ignore">
                        <a href="https://www.facebook.com/JuancaDocenteOficial">Juan C. Avend</a>
                    </blockquote>
                </div>
             </div>
          </div>
