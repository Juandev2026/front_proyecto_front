    ...
    <div className="bg-white py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div
            className="fb-page"
            data-href="https://www.facebook.com/Avendocenteperu"
            data-tabs="timeline"
            data-width="600"
            data-height=""
          ...
          >
            <blockquote
              cite="https://www.facebook.com/Avendocenteperu"
          ...
          {/* Youtube Frame */}
          <div
            className="rounded-xl overflow-hidden shadow-sm border border-gray-200 bg-white flex flex-col h-[500px] hover:shadow-md transition-shadow cursor-pointer"
          ...
          >
            <div className="bg-[#cc0000] p-2 px-3 flex justify-between items-center text-white h-10">
              ...
              <svg
                className="w-5 h-5 bg-white text-[#cc0000] rounded-sm p-[2px]"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
