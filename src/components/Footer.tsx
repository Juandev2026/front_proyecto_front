...
const Footer = () => {
  ...
  return (
    <div className="bg-white border-t border-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
          <img className="h-8 w-auto grayscale opacity-80" src={logo} alt="logo" />
          <div className="text-sm md:text-base text-gray-400 font-medium">
            &copy; 2026 Avendocente PERÚ. Todos los derechos reservados.{' '}
            <Link href="/politica-privacidad">
              <a className="text-gray-400 hover:text-primary underline decoration-solid underline-offset-2 transition-colors">
