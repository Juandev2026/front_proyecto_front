...
const Recursos = () => {
  ...
  // Auto-select level if only one is available and it's "NINGUNO" (hidden)
  useEffect(() => {
    const firstNivel = availableNiveles[0];
    if (availableNiveles.length === 1 && firstNivel?.nivelNombre?.toUpperCase() === 'NINGUNO' && selectedNivel === '') {
