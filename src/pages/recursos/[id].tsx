...
const MaterialPreview = ({
  ...
  const getWhatsAppUrl = () => {
    ...
    const message = encodeURIComponent(
      `Hola, me interesa comprar el recurso: "${stripHtml(
        material.titulo
      )}" - Precio: S/ ${material.precio?.toFixed(2)}`
    );
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      <Head>
        ...
        <meta
          property="og:title"
          content={`${stripHtml(material.titulo)} | Centro de Recursos`}
        />
        <meta
      ...
      <main className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 mx-auto w-full max-w-4xl lg:max-w-none lg:mx-0">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/50 to-transparent z-10 flex flex-col items-center justify-center p-8 text-center">
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 max-w-md shadow-2xl">
                          ...
                          <p className="text-white/80 mb-6">
                            Adquiere este material para visualizar el contenido
                            completo y descargar los archivos adjuntos.
                          </p>
                          <a
                            href={getWhatsAppUrl()}
                            target="_blank"
            ...
            {(material.archivoUrl ||
              (isPdf && (!material.precio || material.precio === 0))) && (
              ...
              <div className="p-4 space-y-4">
                    ...
                    <a className="block group">
                      <div className="relative overflow-hidden rounded-lg mb-2 bg-gray-100 h-32 flex items-center justify-center">
                        ...
                        {featured.imageUrl ? (
                          ...
                          /\.(jpeg|jpg|gif|png|webp)$/i.test(featured.url) ? (
                          <img
                            src={featured.url}
                            alt={featured.titulo}
                            className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-300"
                      ...
                      <h4
                        ...
                        dangerouslySetInnerHTML={{
                          __html: stripHtml(featured.titulo),
                        }}
                      />
                      <p className="text-xs text-primary font-bold">
                        {featured.precio && featured.precio > 0
                          ? `S/ ${featured.precio}`
                          : 'Gratis'}
                      </p>
                    </a>
                ...
                {featuredMaterials.length === 0 && (
                  <p className="text-sm text-gray-500 text-center py-4">
                    No hay otros recursos recientes.
                  </p>
                )}
              </div>
            </div>
