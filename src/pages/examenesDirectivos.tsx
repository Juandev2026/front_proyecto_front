...
const ExamenesDirectivosPage = () => {
  ...
  const exams = [
    ...
    {
      id: '2016_DIRECTIVOS',
      title: 'MINEDU- 2016 DIRECTIVOS',
      count: '1 examen',
    },
    {
      id: '2016_ESPECIALISTA',
      title: 'MINEDU 2016 - ESPECIALISTA',
      count: '5 exámenes',
    },
  ...
  return (
    <PremiumLayout
      ...
      breadcrumb="Pages / Exámenes MINEDU y Simulacros"
    >
      <Head>
      ...
      <div className="w-full space-y-6">
        ...
        <div className="space-y-3">
          {exams.map((exam) => (
            <div
              key={exam.id}
              className="border border-cyan-400 rounded-lg bg-white overflow-hidden"
            >
              <button
        ...
        <div className="flex justify-end gap-4 mt-6">
          <button className="flex items-center gap-2 px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors font-medium bg-white">
