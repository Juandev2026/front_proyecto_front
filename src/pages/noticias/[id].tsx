...
const NewsDetail = ({
  ...
  const plainDescription = newsItem.descripcion
    ? stripHtml(newsItem.descripcion)
    : '';
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Head>
        ...
        />
        {newsItem.imageUrl && (
          <meta property="twitter:image" content={newsItem.imageUrl} />
        )}
      </Head>
              ...
              <div className="p-6 md:p-8 border-b border-gray-100">
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: linkifyHtml(newsItem.descripcion),
                  }}
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                {featuredNews.slice(0, 5).map((featured) => (
                  <Link
                    key={featured.id}
                    href={`/noticias/${createSlug(featured.titulo)}`}
                  >
