                  ...
                  <div className="space-y-6 text-gray-600 text-base leading-relaxed text-justify">
                    <FadeIn delay={0.3}>
                      <p className="border-l-4 border-primary pl-4 italic bg-blue-50/50 py-2 rounded-r-lg">
                        ...
                        profesional de los docentes a través de contenido claro
                        y herramientas que facilitan su labor diaria.
                      </p>
                    </FadeIn>
                    <FadeIn delay={0.4}>
                      <p>
                        Nacido desde la experiencia en el aula y el compromiso
                        con una educación más sólida, este proyecto busca
                        brindar orientación confiable, soluciones prácticas y un
                        entorno donde los maestros encuentren recursos que
                        impulsen su trabajo y sus metas.
                      </p>
                    </FadeIn>
                    <FadeIn delay={0.5}>
                      <p>
                        Creemos que, cuando se ofrece claridad, apoyo y
                        herramientas útiles en un mismo lugar, los docentes
                        avanzan con confianza y fortalecen su impacto en la
                        educación.
                      </p>
                    </FadeIn>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <FadeIn key={idx} delay={idx * 0.1}>
                    <div
                      className={`p-6 rounded-xl shadow-sm border ${item.color} border-opacity-50 hover:shadow-lg transition-all hover:-translate-y-1 bg-white h-full group`}
                    >
                      <div
                        className={`w-14 h-14 rounded-full flex items-center justify-center mb-5 ${item.bgClass} ${item.iconClass} shadow-inner group-hover:scale-110 transition-transform`}
                      >
                        {item.icon}
                      </div>
          ...
          <FadeIn direction="up" fullWidth>
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-gray-50 px-4 text-2xl font-bold text-gray-500 uppercase tracking-widest">
                  Valores
                </span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <FadeIn delay={0.1}>
                  <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 active:scale-95 active:shadow-inner relative overflow-hidden group h-full cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed text-justify relative z-10">
                      Compartimos contenido confiable y explicado de forma
                      sencilla, para que cada docente comprenda los cambios y
                      actualizaciones sin confusiones. Creemos que la
                      información clara es una herramienta poderosa para tomar
                      mejores decisiones.
                    </p>
                  </div>
                </FadeIn>
                ...
                <FadeIn delay={0.2}>
                  <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 active:scale-95 active:shadow-inner relative overflow-hidden group h-full cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed text-justify relative z-10">
                      Cada recurso, herramienta o guía está pensado para
                      resolver necesidades reales del trabajo docente.
                      Priorizamos materiales que ahorren tiempo, faciliten la
                      planificación y aporten soluciones concretas al día a día
                      en aula.
                    </p>
                  </div>
                </FadeIn>
                ...
                <FadeIn delay={0.3}>
                  <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 active:scale-95 active:shadow-inner relative overflow-hidden group h-full cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed text-justify relative z-10">
                      Impulsamos el desarrollo continuo del docente, brindando
                      orientaciones y herramientas que fortalecen su desempeño y
                      abren nuevas oportunidades en su trayectoria educativa.
                      Apostamos por el aprendizaje constante como base de una
