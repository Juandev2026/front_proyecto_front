          ...
          <div className="bg-[#EBF5FF] rounded-none md:rounded-xl p-4 md:p-6 border-y md:border border-blue-100 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                className="w-full bg-[#4790FD] hover:bg-[#3b7ddd] text-white font-bold py-3 px-4 rounded-md shadow-md flex items-center justify-center gap-2 mt-2 transition-colors"
              >
