        ...
        <div className="space-y-4">
              ...
              <div className="mt-4 p-5 bg-[#F0F7FF] rounded-2xl border border-blue-100 shadow-sm animate-fadeIn">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[#2B3674] font-black">
                      ...
                      return (
                        <div
                          ...
                          className={`flex flex-col items-center justify-center p-3 rounded-lg border transition-all ${
                            count > 0
                              ? 'bg-[#F0FFF4]/30 border-green-100 text-[#05CD99]'
          ...
          <div className="border border-primary rounded-lg p-5 bg-white shadow-sm">
                    ...
                    <div className="flex flex-col flex-1">
                      <span
                        className={`font-black text-sm leading-tight ${
                          available ? 'text-[#2B3674]' : 'text-gray-400'
                        }`}
                      >
                        {fullName}
                      </span>
                      <span
                        className={`text-[11px] font-bold mt-1 ${
                          available ? 'text-[#05CD99]' : 'text-gray-400'
                        }`}
                      >
                        {data?.cantidad || 0} preguntas{' '}
            ...
            <p className="text-[11px] text-[#A3AED0] mt-4 font-medium italic">
              * Selecciona al menos un tipo de pregunta. Los tipos en gris no
              tienen preguntas disponibles en esta sección.
            </p>
          </div>
              ...
              <div className={`space-y-4 ${isDesgloseOpen ? 'block animate-fadeIn' : 'hidden'}`}>
                {Object.entries(conteoPreguntas).map(([shortName, data]) => {
                  ...
                  return (
                    <div
                      key={shortName}
                      className="bg-[#F8FBFF] border border-blue-100 rounded-[2rem] p-6 relative overflow-hidden group"
                    >
                      ...
                      <div className="flex justify-between items-start mb-5 relative z-10">
                        <div>
                          <h4 className="text-[#344079] font-black text-lg mb-1">
                            {fullName}
                          </h4>
                        </div>
            ...
            <div className="border border-[#BEE3F8] rounded-[2.5rem] p-8 md:p-10 bg-white shadow-2xl shadow-blue-900/5 mt-10 animate-fadeIn">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-3">
                    {Object.entries(tiposPregunta).map(
                      ([shortName, checked]) => {
                        if (!checked) return null;
                        const data = conteoPreguntas[shortName];
                        const fullName =
                          TIPO_FULL_NAMES[shortName] || shortName;
                        return (
                          <div
                            key={shortName}
